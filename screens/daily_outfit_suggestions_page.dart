...
class _DailyOutfitSuggestionsPageState extends State<DailyOutfitSuggestionsPage> {
  ...
  Map<String, String> get _currentSuggestion {
    if (_currentRangeSuggestions.isNotEmpty) {
      ...
      return {'top': 'No suggestion for this temperature', 'bottom': '', 'color_match': ''};
    }
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (currentSuggestion.containsKey('footwear')) // Add footwear if available
              Text(
                "Footwear: ${currentSuggestion['footwear'] ?? 'N/A'}",
                style: const TextStyle(fontSize: 20),
              ),
            if (currentSuggestion.containsKey('accessories')) // Add accessories if available
              Text(
